...
class ReadingProgressManager {
  ...
  int loadInitialProgress(EpubBook book) {
    ...
    if (progress != null) {
      ...
      print(
          'Set initial page: last read display page ${progress.lastPage}, same page index $lastReadPage');
      return lastReadPage;
    } else {
  ...
  Future<void> loadReadingProgress(
    ...
    if (progress != null && pages.isNotEmpty) {
      ...
      print(
          '📖 Found saved progress: jumping to page ${lastPage + 1} (index $lastPage)');
  ...
  void saveProgressSync(EpubBook book, List<String> pages, int currentPage) {
    ...
    try {
      ...
      print(
          '✅ Saved reading progress on exit: page ${currentPage + 1} of ${pages.length}');
    } catch (e) {
  ...
  Future<void> saveProgress(
      EpubBook book, List<String> pages, int currentPage) async {
    if (pages.isEmpty || currentPage < 0) {
      return;
    }
    ...
    try {
      ...
      print(
          '✅ Saved reading progress: page ${currentPage + 1} of ${pages.length}');
    } catch (e) {
